...
trait Coordinate[F[_]] { this: ConsulApi[F] =>
  ...
  def coordinateLANNodes(dc: Option[String] = None, token: Option[String] = None): F[Result[List[NodeCoordinate]]] = {
  ...
  def coordinateLANNode(node: String, dc: Option[String] = None, token: Option[String] = None): F[Result[Option[List[NodeCoordinate]]]] = {
