...
trait Agent[F[_]] { this: ConsulApi[F] =>
  ...
  /**
   * PUT /agent/maintenance This endpoint places the agent into "maintenance mode". During maintenance mode, the node will be marked as
   * unavailable and will not be present in DNS or API queries. This API call is idempotent.
   * @param enable
  ...
  /**
   * PUT /agent/check/pass/:check_id This endpoint is used with a TTL type check to set the status of the check to passing and to reset the
   * TTL clock.
   * @param checkId
   *   - check id
   * @param note
  ...
  /**
   * PUT /agent/check/warn/:check_id This endpoint is used with a TTL type check to set the status of the check to warning and to reset the
   * TTL clock.
   * @param checkId
   *   - check id
   * @param note
  ...
  /**
   * PUT /agent/check/fail/:check_id This endpoint is used with a TTL type check to set the status of the check to critical and to reset the
   * TTL clock.
   * @param checkId
   *   - check id
   * @param note
  ...
  /**
   * PUT /agent/check/update/:check_id This endpoint is used with a TTL type check to set the status of the check and to reset the TTL
   * clock.
   * @param checkId
  ...
  /**
   * PUT /agent/service/deregister/:service_id This endpoint removes a service from the local agent. If the service does not exist, no
   * action is taken.
   * @param serviceId
   *   - service id
   * @param token
  ...
  /**
   * PUT /agent/service/maintenance/:service_id This endpoint places a given service into "maintenance mode". During maintenance mode, the
   * service will be marked as unavailable and will not be present in DNS or API queries. This API call is idempotent. Maintenance mode is
