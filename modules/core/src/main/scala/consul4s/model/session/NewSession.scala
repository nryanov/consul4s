...
/**
 * @param Node - Specifies the duration for the lock delay. This must be greater than 0. Example: "15s"
 * @param LockDelay - Specifies the name of the node. This must refer to a node that is already registered.
